                        ...
                        <div class="p-2">
                            <div>
                                <h2 class="text-lg">
                                    ...
                                    - <button class="bg-green-200 hover:bg-green-500 px-2 bold rounded" onclick="confirm('Are you sure you want to log task {{$key}} ?') || event.stopImmediatePropagation()" wire:click="logTaskFormatTask('{{$key}}')">Log</button>
                                </h2>
                            </div>
                            ...
                            <div class="p-2">
                                <div>
                                    <h2 class="text-lg"><a class="{{$realLink ? 'underline text-blue-500' : 'cursor-default pointer-events-none'}} bold" href="{{$realLink}}{{$key}}" target="_blank">{{$key}}</a>
                                        ...
                                        - <button class="bg-red-200 hover:bg-red-500 px-2 bold rounded" onclick="confirm('Are you sure you want to unlog task {{$key}} ?') || event.stopImmediatePropagation()" wire:click="unLogTaskFormatTask('{{$key}}')">Unlog</button>
                                    </h2>
                                </div>
